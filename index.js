...
var session = conf.session.replace(/KENTECH_MD V5;;;=>/g,"");
...
setTimeout(() => {
    async function main() {
        ...
        const sockOptions = {
            ...
            browser: ['KENTECH_MD', "safari", "1.0.0"],
                                   ...
                                   // txt += `message supprimé \n @${auteurMessage.split("@")[0]} rétiré du groupe.`;
                                    ...
                                    var action = await recupererActionJid(origineMessage);
                                      ...
                                      if (action === 'remove') {
                                        ...
                                        txt += `message deleted \n @${auteurMessage.split("@")[0]} removed from group by Kentech.`;
...
zk.ev.on('group-participants.update', async (group) => {
    ...
    try {
        ...
        ppgroup = 'https://telegra.ph/file/32c911b4b4ac4eaed7810.jpg';
    }
    ...
    async  function activateCrons() {
        ...
        zk.ev.on("connection.update", async (con) => {
            ...
            if (connection === "connecting") {
                ...
                console.log("✅ kentech md connected successfully☺️");
                console.log("--");
                await (0, baileys_1.delay)(200);
                console.log("------");
                await (0, baileys_1.delay)(300);
                console.log("------------------/-----");
                console.log("Kentech Md by Beltah installing cmds😇\n\n");
                ...
                console.log("Kentech md successfully connected✅");

                await activateCrons();
                
                if((conf.DP).toLowerCase() === 'yes') {     
                let cmsg = `KENTECH MD IS RUNNING NOW...
...
> THANK YOU FOR LOVING KENTECH_MD.\n`;
